...
public class EmployeeData {
    ...
    public enum Gender {
        Male, Female, NonBinary, SeaCaptain, Other, Yes, Definitely, MostLikely, No, Maybe, ProbablyNot,
        GenderHazyTryAgain, AskAgainLater,
        /**
         * My dear sir, there are individuals roaming the streets of Fallen London at
         * this very moment with the faces of squid! Squid! Do you ask them their
         * gender? And yet you waste our time asking me trifling and impertinent
         * questions about mine? It is my own business, sir, and I bid you good day.
         */
        DoNotAskAgainEverYouHaveBeenWarned, Unknown
    }
