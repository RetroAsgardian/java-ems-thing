...
public class PartTimeEmployee extends Employee {
    ...
    public PartTimeEmployee(int ID, String firstName, String lastName, Gender gender, double deductionRate, double hourlyWage, double hoursPerWeek, double weeksPerYear) {
        super(ID, firstName, lastName, gender, deductionRate);
        data = new PTEmployeeData(ID, firstName, lastName, gender, deductionRate, hourlyWage, hoursPerWeek, weeksPerYear);
    }
    ...
    public static class PTEmployeeData extends EmployeeData {
        ...
        public PTEmployeeData(int ID, String firstName, String lastName, Gender gender, double deductRate, double hourlyWage, double hoursPerWeek, double weeksPerYear) {
